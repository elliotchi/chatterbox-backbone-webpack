...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// YOU DO NOT NEED TO EDIT this code. But do take the time to understand what it's doing.
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {const Message = Backbone.Model.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {var Message = __webpack_require__(2);

	const Message = Backbone.Collection.extend({
	  model: Message,
	  url: 'https://api.parse.com/1/classes/chatterbox/',
	  ...
	  parse: (response, options) => {
	    return response.results.reduceRight((arr, curr) => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {const FormView = Backbone.View.extend({
	  initialize: () => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {const MessageView = Backbone.View.extend({
	  initialize: () => {
	  ...
	  renderMessage: message => {
	    if(!this.onscreeMessages[message.get('objctId')]) {
	      var messageView = new MessageView({
	        model: message
	      });

	      this.$el.prepend(messageView.render());
	      this.onscreeMessages[message.get('objectId')] = true;
	    }
	  }
	});
